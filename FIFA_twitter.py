...
collection = db.twitter_football
...
def set_rules():
    ...
    football_rules = [
        {"value": "FIFAWorldCup2022 ", "tag": "FIFAWorldCup2022"},
        {"value": "Qatar2022 ", "tag": "Qatar2022"},
        {"value": "WorldCup2022 ", "tag": "WorldCup2022"},
        {"value": "FIFA", "tag": "FIFA"},
        {"value": "RoadtoQatar2022 ", "tag": "RoadtoQatar2022"}
        
    ]   
    loader = {"add": football_rules}
    response = requests.post(
        "https://api.twitter.com/2/tweets/search/stream/rules",
        auth=bearer_oauth_stream,
        json=loader,
...
def get_tweet_location(tweet_id):
    ...
    #response_json = tweet_collection.insert_one(response.json())
    # try:
    #     users_list = response_json["data"]
    # except:
    #     users_list = []
    # count_likes = response_json["meta"]["result_count"]
    try:
